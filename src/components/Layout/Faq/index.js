				...
				<div className='faq__list'>
					<div className='faq__item'>
						...
						<div className='faq__item-desc'>
							All users can register to Page365 for free forever,
					...
					<div className='faq__item'>
						...
						<div className='faq__item-desc'>
							No. Page365 do not charge or take percentage from
					...
					<div className='faq__item'>
						...
						<div className='faq__item-desc'>
							You can easily register to Page365 for free by
							clicking START FREE. Then, connect your Facebook and
							Facebook Pages to Page365. Learn more
						</div>
					</div>
					<div className='faq__item'>
						<div className='faq__item-title'>
